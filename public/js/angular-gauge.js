(function (angular) {
    ...
    function gaugeMeterDirective() {
        ...
        var tpl = '<div style="display:inline;text-align:center;position:relative;"><span><u>{{prepend}}</u>{{centertext}}<u>{{append}}</u></span><b>{{label}}</b><canvas></canvas></div>';
        ...
        return {
            ...
            link: function (scope, element) {
                ...
                scope.centertext = angular.isDefined(scope.centertext) ? scope.centertext : defaults.centertext;
                ...
                scope.$watch("centertext", watchData, false);
